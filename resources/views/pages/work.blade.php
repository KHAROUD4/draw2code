	...
	<div class="ag-subheader">
				...
				<div class="media-wrapper">
						<div class="media-container media-header">
							...
							<div class="bg-source bg-source--image" style="background-image: url(images/hero_03.jpg);">
							</div>
						...
						<div class="media-container-title txt-center">
								...
								<p class="work-hero-subtext">A showcase of engineered packaging and digital products, built for performance and ready for the US market.</p>
						</div>
					</div>
				</div>
		...
		<div class="container large-container pb-80 pt-80">
			<div class="portfolio-filter">
					 ...
					 <ul class="grid" data-isotope='{ "itemSelector": ".ptf-item", "layoutMode": "fitRows"}'>
						 <li class="ptf-item branding" data-category="branding">
							 <div class="grid-item-wrapper">
	 							<a class="portfolio-link" href="#"></a>
									...
									<div class="project-flow-labels"><span>Designed</span><span>Built</span><span>Deployed</span></div>
	 				 		 </div>

						 </li>
						 <li class="ptf-item illustration" data-category="illustration">
							<div class="grid-item-wrapper">
							 <a class="portfolio-link" href="#"></a>
								 <div class="ag-gridGallery__img-container">
						...
						<li class="ptf-item webdesign" data-category="webdesign">
							<div class="grid-item-wrapper">
							 <a class="portfolio-link" href="#"></a>
								 <div class="ag-gridGallery__img-container">
						...
						<li class="ptf-item artdirection" data-category="artdirection">
							<div class="grid-item-wrapper">
							 <a class="portfolio-link" href="#"></a>
								 <div class="ag-gridGallery__img-container">
									 <img src="images/portf_03.jpg" alt title="portfolio1">
								 </div>
								 <div class="portfolio-overlay">
									 <div class="portfolio-inner">
										 <i class="ag-icon glyphicon glyphicon-link ag-icon__circled-icon"></i>
						...
						<li class="ptf-item branding" data-category="branding">
							<div class="grid-item-wrapper">
							 <a class="portfolio-link" href="#"></a>
								 <div class="ag-gridGallery__img-container">
									 <img src="images/portf_01.jpg" alt title="portfolio1">
								 </div>
								 <div class="portfolio-overlay">
									 <div class="portfolio-inner">
										 <i class="ag-icon glyphicon glyphicon-link ag-icon__circled-icon"></i>
